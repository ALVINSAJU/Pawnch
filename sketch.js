...
var knifeImage , fruit1, fruit2 ,fruit3,fruit4, monsterImage, gameOverImage, knifeSwooshSound, gameOver;
...
function draw() {
  ...
  if(gameState===PLAY){
    ...
    if (score>0 && score%2===0){
      fruitGroup.setVelocityXEach=fruitGroup+2
      fruitGroup.setVelocityYEach=fruitGroup+2
    }

    if (score>0 && score%10===0){
      monster.velocityX=-(8+(score/10))
      fruits.velocityX=-(4+(score/10))
    }
